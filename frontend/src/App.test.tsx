...
describe('App - Filter', () => {
  ...
  it('opens the filter popup when the Filter button is clicked', async () => {
    mockedUseUsers.mockReturnValue({ ...baseHookReturn, users: multiUsers, loading: false });
    const user = userEvent.setup();
    render(<App />);
  ...
  it('filters the table when a filter is applied', async () => {
    mockedUseUsers.mockReturnValue({ ...baseHookReturn, users: multiUsers, loading: false });
    const user = userEvent.setup();
    render(<App />);
  ...
  it('closes the popup without changing the table when Cancel is clicked', async () => {
    mockedUseUsers.mockReturnValue({ ...baseHookReturn, users: multiUsers, loading: false });
    const user = userEvent.setup();
    render(<App />);
  ...
  it('restores all users when filters are cleared after being applied', async () => {
    mockedUseUsers.mockReturnValue({ ...baseHookReturn, users: multiUsers, loading: false });
    const user = userEvent.setup();
    render(<App />);
